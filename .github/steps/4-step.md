...
1. Abre el panel **Copilot Chat** y cambia a **Plan Agent**.
   ...
   <img width="350" alt="image" src="https://github.com/DarioRoblesUnahur/unahur-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. Revisa el plan propuesto y cuando estés satisfecho con él, haz clic en **Start implementation** para transferir a **Agent Mode**.
   ...
   <img width="350" alt="image" src="https://github.com/DarioRoblesUnahur/unahur-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
